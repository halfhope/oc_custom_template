...
//Module Types
$_['module_type0'] = 'Шаблон для схемы';
...
$_['entry_customer_group_help'] = 'Если не используется, оставьте пустым';
...
$_['entry_language_help']       = 'Если не используется, оставьте пустым';
