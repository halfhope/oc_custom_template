...
#form-module-custom-template .form-group + .form-group{
					...
					<div class="panel panel-default" id="panel<?php echo $module_row ?>">
						<div class="panel-body">
							...
							<div class="form-group required stemplate module<?php echo $module_row ?> general<?php echo $module_row ?>">
								<label class="col-sm-2 control-label" for="custom_template_module_<?php echo $module_row ?>_template_name"><?php echo $entry_template; ?></label>
								<div class="col-sm-10">
									...
									<div class="help-block"><?php echo $entry_template_help; ?></div>
								</div>
							</div>
...
function addModule(){
 ...
 html += '<a href="#" onclick="$(this).parent().find(\':checkbox\').prop(\'checked\', true);return false;"><?php echo $text_select_all; ?></a> / <a href="#" onclick="$(this).parent().find(\':checkbox\').prop(\'checked\', false);return false;"><?php echo $text_unselect_all; ?></a>';
	...
	html += '<label class="col-sm-2 control-label" for="custom_template_module_' + module_row + '_template_name"><?php echo $entry_template; ?></label>';
	html += '<div class="col-sm-10">';
	...
	html += '</span>';
	html += '</div>';
	html += '<div class="help-block"><?php echo $entry_template_help; ?></div>';
	html += '</div>';
	html += '</div>';
