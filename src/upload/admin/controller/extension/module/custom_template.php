...
class ControllerExtensionModuleCustomTemplate extends Controller
{
	...
	public function index()
	{
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$this->response->redirect($this->url->link('extension/module/custom_template', 'user_token=' . $this->session->data['user_token'], 'SSL'));
		}
	...
	public function check_file()
	{
		...
		if (isset($this->request->post['path']) && $this->validate()) {
			...
			$path = DIR_CATALOG . 'view/theme/' . $theme . '/template/' . $this->request->post['path'] . '.twig';
