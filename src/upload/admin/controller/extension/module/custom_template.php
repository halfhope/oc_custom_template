...
class ControllerExtensionModuleCustomTemplate extends Controller
{
	...
	public function index()
	{
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$this->response->redirect($this->url->link('extension/module/custom_template', 'token=' . $this->session->data['token'] . '&store_id=' . $data['selected_store_id'], 'SSL'));
		}
		...
		$data['stores'][] = array(
			...
			'link' => $this->url->link('extension/module/custom_template', 'token=' . $this->session->data['token'] .'&store_id=0', 'SSL')
		);
		...
		foreach ($results as $result) {
			$data['stores'][] = array(
				...
				'name' => $result['name'],
				'link' => $this->url->link('extension/module/custom_template', 'token=' . $this->session->data['token'] .'&store_id=' . $result['store_id'], 'SSL')
			);
		}
