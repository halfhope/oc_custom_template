...
$_['entry_template']       = 'Файл нового шаблона: <span class="help"> Путь задается относительно директории шаблона. <br>Например, default/template/product/category.tpl</span>';
